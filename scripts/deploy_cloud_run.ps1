...
gcloud run deploy night-clerk `
  ...
  --set-env-vars "NIGHT_CLERK_MODE=gcp,NIGHT_CLERK_MODEL=gemini-3.5-flash,GOOGLE_CLOUD_PROJECT=$Project,GOOGLE_CLOUD_LOCATION=$ModelLocation,GOOGLE_GENAI_USE_VERTEXAI=true,NIGHT_CLERK_BUCKET=$env:NIGHT_CLERK_BUCKET" `
  --min-instances 0
